...
const Blog = (props) => {
  ...
  return (
    <div className="col-10 offset-1 card mt-7">
      ...
      <p>
        ...
        gói. Giấy giữ form giày sẽ bỏ khi vận chuyển, khách hàng yêu cầu vẫn có.
      </p>
      <p>
      ...
      <p>
        3 . Chúng Tôi chịu trách nhiệm 100% sản phẩm của Chúng Tôi bán ra , nếu
        Quý Khách phát hiện BountySneakers bán hàng nhái , hàng fake Chúng Tôi
        sẽ đền tiền gấp 10 lần giá trị sản phẩm Quý Khách mua hàng.
      </p>
      <hr />
      ...
      <p>
        ...
        Tôi sẽ Bảo Hành cho Quý Khách trong vòng 1 tháng . Sẽ tiến hành sửa chữa
        khắc phục cho Quý Khách
      </p>
      <p>
        3 . Khách Hàng mua hàng phải có Hoá Đơn Mua Hàng (Hoá đơn online khi đặt
        hàng) để chúng Tôi xác minh thời gian được Bảo Hành.
      </p>
