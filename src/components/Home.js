...
import third from "../static/images/slider/1.jpg";
import fourth from "../static/images/slider/2.jpg";
...
const Home = (props) => {
  ...
  return (
    <>
      {/* <div id="slides" className="carousel mb-5" data-ride="carousel">
      ...
      <div className="container-fluid padding">
        <div className="row welcome mini-card">
          <h4 className="title text-primary mb-0">Sản phẩm mới</h4>
        </div>
      </div>
